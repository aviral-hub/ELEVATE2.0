...
import heroIllustration from "../../public/Ignite your potential unleash your success.png";
...
export default function Hero2() {
  ...
  return (
    <div className="h-full mt-[100px] mb-[20px] w-[100%] mx-auto flex flex-col items-center xl:flex-col sm:flex-col md:flex-col" style={{ height: "90vh", justifyContent: "center" }}>
  <div className="flex flex-1" style={{ height: "70%", width: "100%", justifyContent: 'center', alignItems: "center" }}>
    <Image src={heroIllustration} alt="timeline" objectFit="fit" fill={false} className="md:px-0 sm:h-[65vh] sm:w-[85vw] sm:-mt-[0] h-[35vh] w-[95vw] mt-[10vh] justify-center" />
  </div>
  <div className="flex flex-col flex-wrap  xl:px-none flex-1 self-center gap-20 justify-evenly ">
    <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mt-[-15vh] sm:-mt-[0] sm:w-[55vw] w-[75vw] " >
      <a href={"https://forms.gle/qHrGFhQ6aw8KfiEn7"} target="_blank">
        <Button radius="xl" size="md" className={`w-full button-50 min-w-56   `}>
          ...
          <p className="font-spaceGrotesk text-lg font-bold mx-4">Register Now 🔥</p>
        </Button>
      </a>
    </div>
  </div>
